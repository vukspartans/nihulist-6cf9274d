-- Add personalized_body_html column to rfp_invites table
ALTER TABLE public.rfp_invites 
ADD COLUMN IF NOT EXISTS personalized_body_html text;

-- Update the send_rfp_invitations function to personalize email content
CREATE OR REPLACE FUNCTION public.send_rfp_invitations(
  project_uuid uuid, 
  selected_supplier_ids uuid[] DEFAULT NULL::uuid[], 
