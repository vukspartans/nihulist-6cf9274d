...
-- Fix 1: Add advisor read access to project-files bucket
...
-- Fix 2: Replace fragile rfp-request-files advisor policy
DROP POLICY IF EXISTS "Advisors can view invited RFP files" ON storage.objects;
