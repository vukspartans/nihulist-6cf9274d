  ...
  const handleExportPDF = async () => {
    try {
      await generateProposalPDF({
        ...
        companyLogoUrl: advisorInfo?.logo_url || undefined,
        advisorCompany: advisorInfo?.company_name || undefined,
        price: displayPrice,
        ...
        selectedServices: proposal.selected_services?.map((s: any) => {
          const id = typeof s === 'string' ? s : s.id;
          return serviceNames[id] || (typeof s === 'string' ? s : s.name || s.description) || id;
        }).filter(Boolean),
