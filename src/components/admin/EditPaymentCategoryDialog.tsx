...
import { useUpdatePaymentCategory, type PaymentCategory } from "@/hooks/usePaymentCategories";
import { adminTranslations } from "@/constants/adminTranslations";

interface EditPaymentCategoryDialogProps {
...
export function EditPaymentCategoryDialog({
  category,
  open,
  onOpenChange,
}: EditPaymentCategoryDialogProps) {
      ...
      <DialogContent className="sm:max-w-md" dir="rtl">
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          <div className="space-y-2">
            <Label htmlFor="edit-name">{t.dialog.nameLabel}</Label>
            <Input
              id="edit-name"
              value={name}
            ...
            {category?.is_system && (
              <p className="text-xs text-muted-foreground">
                {t.systemCategoryWarning}
              </p>
            )}
          </div>
          
          <div className="space-y-2">
            <Label htmlFor="edit-nameEn">{t.dialog.nameEnLabel}</Label>
            <Input
              id="edit-nameEn"
              value={nameEn}
          ...
          <div className="space-y-2">
            <Label htmlFor="edit-description">{t.dialog.descriptionLabel}</Label>
            <Textarea
              id="edit-description"
              value={description}
          ...
          <div className="flex items-center justify-between">
            <Label htmlFor="edit-isActive">{adminTranslations.common.active}</Label>
            <Switch
              id="edit-isActive"
              checked={isActive}
