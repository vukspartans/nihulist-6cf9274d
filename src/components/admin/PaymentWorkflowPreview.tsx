...
export function PaymentWorkflowPreview({ statuses }: PaymentWorkflowPreviewProps) {
  ...
  return (
    <div className="bg-muted/30 rounded-lg p-4 mb-6">
      <h3 className="text-sm font-medium mb-3 text-muted-foreground">תצוגה מקדימה של תהליך האישור</h3>
      ...
      {terminalStatuses.length > 0 && (
        <div className="mt-3 pt-3 border-t border-dashed flex items-center gap-2" dir="ltr">
          <span className="text-xs text-muted-foreground ml-2">סטטוסי סיום נוספים:</span>
